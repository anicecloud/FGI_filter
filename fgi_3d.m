function [V_FILTERED_CPU,V_IMPULSE_CPU] = fgi_3d(V,r,q,i,integrated)
% Fast Volumetric FGI filter
...
gpu = gpuDevice;
k_imp = parallel.gpu.CUDAKernel("fgi_3D_kernels.ptx","3D_FGI/fgi_kernels.cu","computeImpulsivity");
k_fuzzy = parallel.gpu.CUDAKernel("fgi_3D_kernels.ptx","3D_FGI/fgi_kernels.cu","fuzzyFilter");
